                ...
                <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <form name="my-form1" onsubmit="return validform()" action="register.php" method="POST">
                                    
                                    <div class="form-group row">
                                        <label for="InputPassword1" class="col-md-4 col-form-label text-md-right">Old Password</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="InputPassword1" class="col-md-4 col-form-label text-md-right">New Password</label>
                                        <div class="col-md-6">
                                            <input type="password" class="form-control" id="InputPassword1" placeholder="Password" name="password" value="<?php echo $password ?>">
                                        </div>
                                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card">
                            <div class="card-header">Change Details</div>
                                <div class="card-body">
                                <form name="my-form2" onsubmit="return validform()" action="register.php" method="POST">
                                    
                                    <div class="form-group row">
                                        <label for="full_name" class="col-md-4 col-form-label text-md-right">Update Name</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="user_name" class="col-md-4 col-form-label text-md-right">Updtae User Name</label>
                                        <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label for="email_address" class="col-md-4 col-form-label text-md-right">Update E-Mail Address</label>
                                        <div class="col-md-6">
